...
| `--ref_cache` | Path | `${projectDir}/reference_cache` | No | Content-addressed bwa-mem2 index cache stored under `<ref_cache>/<genome>/<fasta_sha256>/<bwa_mem2_version>/bwamem2/`. The Longleaf profile also uses this project-relative default. |
