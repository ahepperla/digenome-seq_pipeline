...
| `--ref_cache` | Path | `${projectDir}/reference_cache` | No | Content-addressed bwa-mem2 index cache. The selected FASTA hash and bwa-mem2 version determine the reusable index directory. The Longleaf profile also uses this project-relative default. |
